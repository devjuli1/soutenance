                    ...
                    <div class="bg-white rounded p-5 m-5 mb-0">
                        <form action="{{route('storeAdmin')}}" method='post'>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-6">
                                    <input type="text" name='ville' class="form-control bg-light border-0" placeholder="Votre ville" style="height: 55px;">  
                                </div>
                                <div class="col-12 col-sm-6">
                                    <input type="number" name='age' min="20" class="form-control bg-light border-0" placeholder="Votre Age" style="height: 55px;">
                                </div>
                                <div class="col-12 col-sm-6">
