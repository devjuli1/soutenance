            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="prix.blade.php" class="nav-item nav-link">Prix</a>
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Offre</a>
                            <div class="dropdown-menu m-0">
                                <!-- <a href="blog.html" class="dropdown-item">Blog Grid</a> -->
                                <a href="categorie.blade.php" class="dropdown-item">Catégories</a>
                                <a href="specialiste.blade.php" class="dropdown-item">Spécialités_infos</a>
                                <a href="temoignages.blade.php" class="dropdown-item">Temoignages</a>
                                <a href="RDV.blade.php" class="dropdown-item">Rendez-Vous</a>
                                <a href="recherche.blade.php" class="dropdown-item">Recherche un spécialiste</a>
                            </div>
                        </div>
