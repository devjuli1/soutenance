        ...
        <div class="container">
            <div class="row">
                <a href="index" class="navbar-brand">
                    <h3 class="m-0 text-uppercase text-primary" text-center><img src="../Images/logo 2.jpg" alt="logo" width="70px";>Le lieu idéal pour résoudre vos problèmes</h3>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            <a href="{{ route('Nos_services') }}" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Services</a>
                            <div class="dropdown-menu m-0">
                                <!-- <a href="blog.html" class="dropdown-item">Blog Grid</a> -->
                                <a href="{{ route('Nos_services') }}" class="dropdown-item"></a>
