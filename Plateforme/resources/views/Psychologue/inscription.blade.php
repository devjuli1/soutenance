                    ...
                    <div class="bg-white rounded p-5 m-5 mb-0">
                        <form action="" method='post'>
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-6">
                                    <select class="form-control bg-light border-0" data-bs-toggle="dropdown" style="height: 55px;">
                                      <option>Votre spécialité</option>
                                      <option>Docteur en psychologie</option>
                                      <option>Psychologue</option>
                                      <option>Psychologue en amour et vie relationnelle</option>
                                      <option>Psychologue / psychothérapeute</option>
                                      <option>Psychologue clinicien(ne) – psychothérapeute</option>
                                      <option>Psychologue du travail</option>
                                      <option>Psychologue du sport</option>
                                      <option>Psychologue en Orientation</option>
                                      <option>Psychopedagogue</option>
                                      <option>Psychopraticien(ne)</option>
                                ...
                                <div class="col-12 col-sm-6">
                                    ...
                                    <input type="text" name='photo'class="form-control bg-light border-0" placeholder="photo" style="height: 55px;">
                                </div>
                                <div class="col-12">
